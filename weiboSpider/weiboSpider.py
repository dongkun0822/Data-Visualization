...
class Weibo:
    cookie = {"Cookie": "SCF=AnLcNT6MVKh8O29wcSNUsAJaK90sTIWE_2tZ1-f0hC1wi35xFx6JlMWL6tXRn_SKk85HjaBgAUohdD7kDbDGpPU.; SUHB=0OMUcxHs6FnpMe; _T_WM=98324378857; SUB=_2A25x9ZUzDeRhGeNN7FAZ9SjMyDqIHXVTGTt7rDV6PUJbkdANLVHckW1NSY2Vm1mP3xUvNai39xuC4RnHF288X5KK; MLOGIN=1; TMPTOKEN=r1YIH3v1GELO5x0jGQ7BMpaqWYiSzECwAxKp4hyEQrQpwwrgHLhjwrEC7VV6YeWQ; SSOLoginState=1559356771; WEIBOCN_FROM=1110006030; M_WEIBOCN_PARAMS=luicode%3D20000174%26uicode%3D20000174; XSRF-TOKEN=cc5e51"}  # 将your cookie替换成自己的cookie
    ...
    def write_txt(self):
        ...
        try:
            ...
            with codecs.open(self.get_filepath("txt"), "wb") as f:
...
def main():
    try:
        ...
        user_id = 2706896955  # 可以改成任意合法的用户id（爬虫的微博id除外）
        ...
        # 读取文件
        #d = "d:\weiboSpider-master\weibo\\2706896955.txt"
        #text = open(d).read()
        #text = open('weibo/2706896955.txt').read()
        # 若是中文文本，则先进行分词操作
